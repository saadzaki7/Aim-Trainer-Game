...
to hit as many\r targets as you can. After wards you will\r be given a score.\
 Try to beat you\r highscore to improve your aim! With consistency\r your aim\
 will surely improve.  ", font=("Arial Bold", 40))
    instructions.place(x=0, y=100)
    #start button
    startB=Button(window,image=startImg,command=start)
    startB.place(x=450, y=600)
